...
\abbrevs{PZ, pheriperal zone; CNN, Convolutional Neural Network; DSC,  Dice coefficient TZ, transition zone; ROI, region of interest; SGD, Stochastic Gradient Descent}
